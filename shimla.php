...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">SHIMLA</h2>
     <div class="h-line bg-dark my-3"></div>
</div>
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/destination/shimla/s1.jpg" class="d-block w-100" alt="...">
...
<br>
<h2 class="fw-bold h-font text-center">SHIMLA PACKAGES</h2>
<br>
<div class="containerr">
  <div class="row w-100" id="rowpackages"  style="display:flex; ">

  <div class="cradp card rounded-0" style="width: 25rem;">
    <img src="image/destination/shimla/s1.jpg" class="w-100" style="width:100px; height:200px;">
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Shimla Tour Package</h5>
      <p class="card-text">Shimla-Kufri-Ridge-Mall Road-Naldehra-Mashobra-Advance Study-Jakhoo Temple Etc.</p>
      <h6 class="card-title">3 Night/ 4 Days </h6>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Shimla Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      <p>
      <b> Day 1: Shimla Local Sightseeing</b><br>
            <li>The day starts by pick up you from chandigarh  and when you reach in shimla first visit ancient Indian Institute of advance Studies, Army Museum, and Jakhoo temple.
            </li>            <br>
            <li>In the evening, explore Shimla city on foot as vehicle entry is prohibited.   </li>       
              <br>
              <li>You can see prime places including Lakkar Bazaar, Ridge, Church, Mall road, Scandal Point, Kali Bari temple etc.   </li>     
              <br>
              <li>Ideal time for shopping and trying out different cuisines on the mall road.     </li>      
              <br>
      <b> Day 2: Shimla-Kufri</b>
        <br>
               <li> After Breakfast, visit to the famous picnic spots around Shimla which include Fagu, Kufri, Naldehra and Mashobra.   </li>      
               <br>
                    
      <b> Day 3:Mashobra-Naldehra<br></b>
        <li> After Breakfast, visit to the famous of Mashobra-Naldehra </li><br>
     
      <b>   Day 4:Narkanda-Tatapani<br> </b> 
        <li> After Breakfast, visit to the famous of Narkanda-Tatapani </li><br>
        <li> Drop you on chandigarh </li><br>
...
<div class="modal " id="policy" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!-- haaaaaaa -->
<br>
<h2 class="fw-bold h-font text-center">BEAUTIFUL PLACES IN SHIMLA</h2>
<br>
<div class="containerr">
  <div class="row" id="rowpackages" style="display:flex; width:100%;">
      ...
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/shimla/advance.jpeg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/kVDzg64CydGu9nmw8" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Advance Study</p></a>
        </div>
      </div>
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/shimla/tiba.jpg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/46H83zxSiyaSCRCWA" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Shali Tiba</p></a>
        </div>
      </div>
