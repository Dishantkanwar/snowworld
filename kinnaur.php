...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">KINNAUR</h2>
     <div class="h-line bg-dark my-3"></div>
</div>
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/destination/kinnaur/5.jpg" class="d-block w-100" alt="...">
...
<br>
<h2 class="fw-bold h-font text-center">KINNAUR PACKAGES</h2>
<br>
<div class="containerr">
  <div class="row w-100" id="rowpackages"  style="display:flex; ">

  <div class="cradp card rounded-0" style="width: 25rem;">
    <img src="image/destination/kinnaur/kinnaur.jpeg" class="w-100" style="width:100px; height:200px;">
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Kinnaur Tour Package</h5>
      <p class="card-text">Shimla-Sarhan Bhima kali Temple-Sangla-Chitkul-Kalpa Etc.</p>
      <h6 class="card-title">8 Night/ 9 Days </h6>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Kinnaur Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      ...
      <b> Day 2: SHIMLA</b>
        <br>
               <li> After Breakfast, visit to the famous Places Shimla to Sarhan Bhima kali Temple & stay</li><br>           
      <b> Day 3:SHIMLA TO KINNAUR<br></b>
        <li> After Breakfast, visit to the famous place Sarhan to Sangla Stay</li><br>
     
      <b>   Day 4:KINNAUR <br> </b> 
        <li> After Breakfast, visit Sangla Local Sightseeing & stay</li><br>
        <b>   Day 5:KINNAUR <br> </b> 
        <li> After Breakfast, Sangla to Chitkul & stay</li><br>
        <b>   Day 6:KINNAUR <br> </b> 
        <li> After Breakfast, Chitkul to Kalpa & stay</li><br>
        <b>   Day 7:KINNAUR <br> </b> 
        <li> After Breakfast, Kalpa Local Sightseeing & stay</li><br>
        <b>   Day 8:KINNAUR TO SHIMLA <br> </b> 
        <li> After Breakfast, Kalpa to Shimla & stay</li><br>
        <b>   Day 9:<br> </b> 
        <li> After Breakfast,Shimla to Chandigarh drop Ralway Station/Airport</li><br>
        </p>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal " id="policy" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!-- haaaaaaa -->
<br>
<h2 class="fw-bold h-font text-center">BEAUTIFUL PLACES IN MANALI</h2>
<br>
<div class="containerr">
  <div class="row" id="rowpackages" style="display:flex; width:100%;">
      ...
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/kinnaur/kilash.jpeg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/kXrWT8msm536JJ8BA" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Kinnaur Kailash</p></a>
        </div>
      </div>
  </div>
</div>
