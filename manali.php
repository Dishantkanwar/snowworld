...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">MANALI</h2>
     <div class="h-line bg-dark my-3"></div>
</div>
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/destination/manali/manali1.jpg" class="d-block w-100" alt="...">
...
<br>
<h2 class="fw-bold h-font text-center">MANALI PACKAGES</h2>
<br>
<div class="containerr">
  <div class="row w-100" id="rowpackages"  style="display:flex; ">

  <div class="cradp card rounded-0" style="width: 25rem;">
    <img src="image/destination/manali/manali.jpeg" class="w-100" style="width:100px; height:200px;">
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Manali Tour Package</h5>
      <p class="card-text">Hadimba Temple-Club house-Tibetan Monastery-Van Vihar-Manali Mall road & local market-Vashisht Temple Etc.</p>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Manali Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      <p>
      <b> Day 1: Manali Local Sightseeing</b><br>
            <li>The day starts by pick up you from chandigarh to manali and when you reach in manali first visit the ancient Hadimba Temple-Club house-Tibetan Monastery-Van Vihar-Manali Mall road & local market-Vashisht Temple.
            </li>            <br>
            <li>In the evening, explore Manali city on foot as vehicle entry is prohibited.   </li>       
                
              <br>
      <b> Day 2: Manali</b>
        <br>
               <li> After Breakfast, visit to the famous Places Manali- Tandi -<br> Keylong - Jispa
                 - Darcha - Baralacha - Return to sissu -<br> Atal Tunnel - Solang Valley - Anjani Mahadev Temple - Manali</li>      
               <br> <b> <li class="text-danger">Note: Attal/Sissu will be on direct payment basis </li></b> <br>
                    
      <b> Day 3:Manali<br></b>
        <li> After Breakfast, visit to the famous place in manali to  Rohtang pass-Nehru Kund-Kothi-Gulaba-Rahalla Fall-Marhi-Rani Nallah-Rohtangpass-Gramphu</li><br>
        <b> <li class="text-danger">Note: Rohtang Pass/Attal will be on direct payment basis </li></b> <br>
     
      <b>   Day 4:Manikaran <br> </b> 
        <li> After Breakfast, visit to the famous places like Mankaran-Kasol</li><br>
...
<div class="containerr">
  <div class="row" id="rowpackages" style="display:flex; width:100%;">
      ...
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/manali/sissu.jpg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/2m3yT8rTcneKt7fj9" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Sissu</p></a>
        </div>
      </div>
  </div>
</div>
