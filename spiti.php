...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">SPITI</h2>
...
<br>
<h2 class="fw-bold h-font text-center">SPITI PACKAGES</h2>
<br>
<div class="containerr">
  <div class="row w-100" id="rowpackages"  style="display:flex; ">

  <div class="cradp card rounded-0" style="width: 25rem;">
    <img src="image/destination/spiti/spiti1.jpeg" class="w-100" style="width:100px; height:200px;">
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Spiti Tour Package</h5>
      <p class="card-text">Shimla-Narakanda-Sarhan Bhima kali Temple-Sangla-Chitkul-Nako-Tabo-Kaza-ChandraTaal-Manali Etc.</p>
      <h6 class="card-title">9 Night/ 10 Days </h6>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Spiti Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      <p>
      <b> Day 1: SHIMLA</b><br>
            <li>The day starts by pick up you from chandigarh to shimal and when you reach in shimla Cheak in Hotel
            evening time going  to  mall roard Shimla.
            </li>            <br>       
      <b> Day 2: SHIMLA</b>
        <br>
          <li> After Breakfast, visit to the famous Places Narkanda stay</li><br>    
          <b> Day 3: SHIMLA</b>
        <br>
          <li> After Breakfast, visit to the famous Place  Sarhan Bhima kali Temple on the way & sangla  chitkul-stay</li><br>         
      <b> Day 4 : KINNAUR<br></b>
        <li> After Breakfast, visit to the famous place  Sangla to kalpa Stay</li><br>
     
      <b>   Day 5:KINNAUR <br> </b> 
        <li> After Breakfast, visit kalpa to Nako stay</li><br>
        <b>   Day 6:KINNAUR <br> </b> 
        <li> After Breakfast, Nako to tabo stay</li><br>
        <b>   Day 7:spiti <br> </b> 
        <li> After Breakfast, Tabo to Kaza stay</li><br>
        <b>   Day 8:spiti <br> </b> 
        <li> After Breakfast, Kaza stay</li><br>
        <b>   Day 9:Spiti<br> </b>
        <li> After Breakfast, Kaza to Chandra Taal & stay</li><br>
        <b>   Day 10:Spiti<br> </b> 
        <li> After Breakfast, Chandra Taal to Manali & stay</li><br>
        <b>   Day 11:<br> </b> 
        <li> After Breakfast,Manali to Chandigarh drop Ralway Station/Airport</li><br>
        </p>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal " id="policy" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!-- haaaaaaa -->
<br>
<h2 class="fw-bold h-font text-center">BEAUTIFUL PLACES IN SPITI</h2>
<br>
<div class="containerr">
  <div class="row" id="rowpackages" style="display:flex; width:100%;">
  <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/spiti/sarahan.jpg" class="w-100 h-30" style="height:150px;" alt="...">
        <div class="card-body text-center">
         <a href="https://maps.app.goo.gl/bcFrv6htMgXzhVt18" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Sarhan Temple</p></a> 
        </div>
      </div>
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/kinnaur/5.jpg" class="w-100 h-30" style="height:150px;" alt="...">
        <div class="card-body text-center">
         <a href="https://maps.app.goo.gl/gK3VUD3Q32pXNKhb8" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Kalpa</p></a> 
        </div>
      </div>
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/kinnaur/chitkul.jpeg" class="w-100 "style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/ZVsgkKrwDZ1H2Mru6" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">CHITKUL</p></a>
        </div>
      </div>
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/spiti/chand.jpeg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/8HbAMJ7ckCNLyHsMA" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Chander Taal</p></a>
        </div>
      </div>
      <div class="card my-3" style="width: 20rem; ">
        <img src="image/destination/spiti/keyy.jpeg" class="w-100" style="height:150px;" alt="...">
        <div class="card-body text-center">
          <p class="card-text fw-bold"></p>
          <a href="https://maps.app.goo.gl/2XXmno2iLCcv3a799" target="_blank" class="text-decoration-none text-dark" style="tex">
          <p class="card-text fw-bold">Key Monastery</p></a>
        </div>
      </div>
  </div>
</div>
