...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">COMBO PACK 3</h2>
...
<br>
<h2 class="fw-bold h-font text-center">COMBO PACK 3 PACKAGES</h2>
<br>
<div class="containerr">
  ...
  <div class="cradp card rounded-0" style="width: 25rem;">
    ...
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Combo Pack 3 Tour Package</h5>
      <p class="card-text">Delhi-Shimla-Kufri-Ridge-Mall Road-Advance Study-Jakhoo -Manali-Hadimba Temple-Club house-Tibetan MonasteryEtc.</p>
      <h6 class="card-title">5 Night/ 6 Days </h6>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Combo Pack 3 Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      <p>
      <b> Day 1: </b><br>
       <li>Delhi- Shimla (By overnight Volvo bus) 350 Kms / approx. 8 to 9 hours :-
       Board Volvo from Delhi in the evening 10:00 PM and start your overnight journey towards Shimla you will reach approx 4-5 AM </li> 
       <b> Day 2: </b>
       <br>
       <li>Then Day 2 starts by pick up you from  Bustand and when you reach in shimla
               then Cheak in Hotel after freshingup Then going look local sightseeing jakhu temple -mall road-Advance study etc
            </li>            <br>       
      <b> Day 3: </b>
        <br>
      ...
      <b>   Day 6: <br> </b> 
        <li> After Breakfast, visit Hadimba Temple-Club house-Tibetan Monastery-Van Vihar-Manali Mall 
          then Droping you near Manali bustand to take Volvo bus towards Delhi you will reach at morning in Delhi
          </li><br>
        </p>
        </div>
      </div>
...
<div class="modal " id="policy" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
 ...
 <!-- haaaaaaa -->
<br>
<h2 class="fw-bold h-font text-center">BEAUTIFUL PLACES IN COMBO 3 PACK</h2>
<br>
<div class="containerr">
