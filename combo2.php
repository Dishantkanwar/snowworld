...
<div class="my-5 px-4">
     <h2 class="fw-bold h-font text-center">COMBO PACK 2</h2>
...
<br>
<h2 class="fw-bold h-font text-center">COMBO PACK 2 PACKAGES</h2>
<br>
<div class="containerr">
  <div class="row w-100" id="rowpackages"  style="display:flex; ">

  <div class="cradp card rounded-0" style="width: 25rem;">
    <img src="image/destination/manali/hadimba.jpg" class="w-100" style="width:100px; height:200px;">
    <div class="card-body">&nbsp;
      <h5 class="card-title fw-bold">Explore Combo Pack 2 Tour Package</h5>
      <p class="card-text">Shimla-Kufri-Ridge-Mall Road-Advance Study-Jakhoo Manali-Hadimba Temple-Club house-Tibetan MonasteryEtc.</p>
...
<div class="modal fade" id="detailspackages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Explore Combo Pack 2 Tour Package Deatils</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="scrool">
      ...
      <b> Day 1: </b><br>
            <li>The day starts by pick up you from chandigarh to shimla and when you reach in shimla
               Cheak in Hotel then going to look local sightseeing if time is possible(jakhu temple -mall road-Advance study etc)
            </li>            <br>       
      <b> Day 2: </b>
        <br>
      ...
      <b>   Day 5: <br> </b> 
        ...
        <b>   Day 6: <br> </b> 
        <li> Then Drop you in Chandigarh</li><br>
        </p>
        </div>
      </div>
      <div class="modal-footer">
